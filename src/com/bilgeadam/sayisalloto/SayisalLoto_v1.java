...
public class SayisalLoto_v1 {
    public static void main(String[] args) {
        ...
        //nextint 0 ile gönderilen sayi -1 aralığında üretilir.
        //1 - gönderilen sayi aralığında üretmesi için +1 ekliyorum
        sayi1 = rnd.nextInt(49)+1;
        sayi2 = rnd.nextInt(49)+1;

        //sayi2 sayi1'e eşit oldugu sürece, sayi2'yi yeniden üret diyoruz.
        //sayi2 sayi1'e eşit olmadığı zaman döngüden çıkabilir.
        while (sayi2 == sayi1)
        {
            sayi2 = rnd.nextInt(49)+1;
